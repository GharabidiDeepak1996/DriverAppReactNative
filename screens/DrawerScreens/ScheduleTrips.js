        ...
        <View>
            ...
            <View style={styles.cardContainer}>
              ...
              <View style={{ paddingStart: 15,paddingTop: 20,}}>
                ...
                <Dash dashGap={4} style={{width:2, height:collapsed ? 40 : (4*30), flexDirection:'column',}}/>
                    <View>
                        {/*Code for Single Collapsible Start*/}
                        <TouchableOpacity onPress={toggleExpanded}>
                            <View style={styles.header}>
                                <Text style={styles.headerText}>View stops</Text>
                                <Icon name={collapsed ? "chevron-down-outline" : "chevron-up-outline"} size={18} color="black" style={styles.icons} />
                        ...
                        <Collapsible collapsed={collapsed} align="center">
                            <View style={styles.content}>
                                {
                                    data.map((item) => (
                                        <View flexDirection='row' key={item.title}>
                ...
                <View style={{ flexDirection: 'row',paddingVertical:10,}}>
                   ...
                   <View style={styles.lableConatiner}>
                    <Text style = {{color: "#406D97",fontSize: 16, fontWeight:'400',paddingLeft:10 }}>Total Pickup-</Text>
                    <Text style = {{color: "#406D97",fontSize: 16, fontWeight:'bold', }}>5</Text>
                   </View>
                </View>
              </View>
